   ...
   function editar_cuenta_form()
   {
      if (!empty($this->data)):
         ...
         if ($this->Usuario->save($usr_update)):
            $this->Session->setFlash('<p><strong>Informaci�n!, </strong> ' . __('El perfil a sido actualizado.', true) . '</p>', 'default', array('class' => 'ui-state-highlight ui-corner-all'));
         else:
            $this->Session->setFlash('<p><strong>Atenci�n!, El perfil de usuario no puede ser actualizado.</strong></p>', 'default', array('class' => 'ui-state-error ui-corner-all', "id" => "msg"));
         endif;
         $this->data = $usuario;
      else:
         ...
         if (empty($this->data)):
            $this->Session->setFlash('<p><strong>Atenci�n!, El perfil de usuario no a sido encontrado.</strong></p>', 'default', array('class' => 'ui-state-error ui-corner-all', "id" => "msg"));
