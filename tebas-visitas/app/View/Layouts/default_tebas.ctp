         ...
         <div id="topbar">
            ...
            <div class="container">
               ...
               <div id="top-nav">
                  ...
                  <ul>
                     <li>Empresa</li>
                     <li><a href="javascript:void(0);" class="login-empresa-planta"><?php echo $empresaUsuario;  ?></a></li>
                     <li>Planta</li>
                     <li><a href="javascript:void(0);" class="login-empresa-planta"><?php echo $sucursalUsuario; ?></a></li>
                  </ul>

                  <ul class="pull-right">
                     <li><a href=""><i class="icon-user"></i><?php echo $nombreUsuario; ?></a></li>
