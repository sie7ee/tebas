<h3 class="ui-widget-header"><?php echo __("Editar Empleado [". $this->data['Empleado']['id'] ."]",true); ?></h3>
<div id="tabs">
   ...
   <?php echo $this->Form->create("Empleado", array('action' => 'edit', 'type' => 'file', 'onkeypress' => 'return event.keyCode!=13', 'id' => 'Form00', 'class' => 'form-horizontal')); ?>
