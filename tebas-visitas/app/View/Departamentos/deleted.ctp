...
<div id="tabs">
    ...
    <?php echo $this->Form->create("Departamento", array('action' => 'deleted', 'type' => 'file', 'onkeypress' => 'return event.keyCode!=13', 'id' => 'Form00', 'class' => 'form-horizontal')); ?>
        ...
        <fieldset>
            ...
            <div class="row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $this->Form->select('gralSucursalId', $sucursales, array('class' => 'input-large')); ?>
...
<script type="text/javascript" src="/js/implementaciones/departamentos/edit.js"></script>